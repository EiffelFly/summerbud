    ...
    <div className={"flex flex-col gap-y-8 " + className}>
      {articles.map((article) => (
        <CustomLink href={article.path} key={article.path}>
          <div
            className={
              "flex flex-col gap-y-4 font-sans rounded-lg bg-sd-white dark:bg-sd-black p-6 border border-sd-brgreen dark:border-sd-brcyan border-opacity-0 dark:border-opacity-0 hover:border-opacity-100 dark:hover:border-opacity-100 cursor-pointer"
            }
          >
