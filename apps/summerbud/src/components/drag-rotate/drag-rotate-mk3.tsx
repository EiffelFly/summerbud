...
// I realize that I didn't calculate the initial rotation angle,
// Because I put the draggable element on the bottom right corner.

export function DragRotateMK3() {
